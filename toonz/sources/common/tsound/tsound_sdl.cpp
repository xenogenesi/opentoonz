...
public:
	...
	TSoundOutputDeviceImp()
		: m_isPlaying(false), m_looped(false), m_supportedRate(),
		  m_opened(false), m_data(NULL), m_volume(SDL_MIX_MAXVOLUME){};
...
bool TSoundOutputDeviceImp::doOpenDevice(const TSoundTrackFormat &format)
{
	...
	default:
		throw TSoundDeviceException(
			TSoundDeviceException::UnableOpenDevice, "invalid bits per sample");
		return false;
	}
